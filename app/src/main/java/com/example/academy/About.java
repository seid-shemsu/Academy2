    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_fb:
                ...
                break;
            case R.id.img_twit:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/Africa_Academy1")));
                break;
            case R.id.img_insta:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/Africa_Academy1")));
                break;
            case R.id.img_you:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtube.com/Africa_Academy1")));
                break;
        }
    }
}